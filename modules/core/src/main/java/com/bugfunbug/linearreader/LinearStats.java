...
public final class LinearStats {
    ...
    public static void recordCacheHit()  { if (enabled) INSTANCE.cacheHits.increment(); }
    public static void recordCacheMiss() { if (enabled) INSTANCE.cacheMisses.increment(); }
    public static void recordWrapperCacheHit()  { if (enabled) INSTANCE.wrapperCacheHits.increment(); }
    public static void recordWrapperCacheMiss() { if (enabled) INSTANCE.wrapperCacheMisses.increment(); }
    public static void recordResidentReload()   { if (enabled) INSTANCE.residentReloads.increment(); }
    public static void recordResidentEviction() { if (enabled) INSTANCE.residentEvictions.increment(); }
    ...
    public static void enableAndReset() {
        enabled = true;
        reset();
    }
