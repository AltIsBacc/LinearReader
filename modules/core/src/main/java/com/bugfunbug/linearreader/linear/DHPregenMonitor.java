...
public final class DHPregenMonitor {
    ...
    private static volatile Boolean testPregenActive;
    ...
    public static boolean isPregenActive() {
        Boolean override = testPregenActive;
        if (override != null) {
            return override;
        }
    ...
    static void setTestPregenActive(Boolean testPregenActive) {
        DHPregenMonitor.testPregenActive = testPregenActive;
    }
